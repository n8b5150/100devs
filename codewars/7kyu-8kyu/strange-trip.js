...
function isLockNessMonster(s) {
    ...
    return s.includes('3.50') || s.toLowerCase().includes('tree fiddy') || s.toLowerCase().includes('three fifty')
  }
...
console.log(isLockNessMonster("Yo, I heard you were on the lookout for Nessie. Let me know if you need 3.50."))
console.log(isLockNessMonster("Yo, I heard you were on the lookout for Nessie. Let me know if you need three fifty."))
