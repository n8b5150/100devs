...
app.post('/addPark', (request, response) => {
    db.collection('parks').insertOne({parkName: request.body.parkName, parkAddress: request.body.parkAddress, likes: 0})
    .then(result => {
...
app.put('/addOneLike', (request, response) => {
    db.collection('parks').updateOne({parkName: request.body.parkNameS, parkAddress: request.body.parkAddressS, likes: request.body.likesS},{
        $set: {
